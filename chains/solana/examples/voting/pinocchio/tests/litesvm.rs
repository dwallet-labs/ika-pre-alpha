...
//! LiteSVM end-to-end tests for the Pinocchio voting example.
//!
...
/// Path to the compiled SBF binary for the Pinocchio voting example.
const VOTING_PROGRAM_BINARY: &str = concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/../../../../../target/deploy/ika_example_voting_pinocchio.so"
);
...
// ═══════════════════════════════════════════════════════════════════════
// Voting program constants (must match pinocchio lib.rs)
// ═══════════════════════════════════════════════════════════════════════
